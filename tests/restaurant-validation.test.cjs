...
const valid = {name:'Test',slug:'test',description:'Seasonal dishes',pickupAddress:'123 Test Street',contactPhone:'+91 98765 43210',dishName:'Bhaat',dishPrice:120};
...
test('each onboarding step validates its own fields and launch checks all fields', () => {
  ...
  assert.equal(restaurantValidationError({...valid,dishPrice:120.5},1).step,1);
